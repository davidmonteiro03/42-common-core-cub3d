...
/*   Updated: 2025/02/15 19:34:36 by dcaetano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				cub_draw_square(t_cub *cub, int x, int y,
						unsigned int color);
void				cub_check_shape(t_cub *cub, int x, int y, char c);

// game utils
void				cub_draw_pixel(t_img *img, int x, int y,
						unsigned int color);
...
// map
// // parse border utils
void				cub_update_parse_up(t_parse *parse, char **strs, int k,
						int l);
void				cub_update_parse_left(t_parse *parse, char **strs, int k,
						int l);
void				cub_update_parse_right(t_parse *parse, char **strs, int k,
						int l);
void				cub_update_parse_down(t_parse *parse, char **strs, int k,
						int l);
...
void				cub_check_maps(char **file_content, int i,
						t_info *map_info);
...
// parse input
char				*cub_check_extension(t_cub *cub, char *arg,
						char *extension);
