...
/*   Updated: 2025/02/15 21:19:28 by dcaetano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!cub_dif_char_in(args[0], "0123456789") || !cub_dif_char_in(args[1],
			"0123456789") || !cub_dif_char_in(args[2], "0123456789"))
		return (multiple_free("%b", args), cub_error_file(cub, ERROR_COLOR,
				false));
